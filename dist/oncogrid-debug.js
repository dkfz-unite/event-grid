...
var OncoGrid = (() => {
      ...
      !(function() {
        ...
        function d3_geo_conic(projectAt) {
          ...
          p.parallels = function(_2) {
            ...
            return m(\u03C60 = _2[0] * \u03C0 / 180, \u03C61 = _2[1] * \u03C0 / 180);
          };
          return p;
        }
        ...
        d3.geo.albersUsa = function() {
          ...
          albersUsa.translate = function(_2) {
            ...
            lower48Point = lower48.translate(_2).clipExtent([[x - 0.455 * k, y - 0.238 * k], [x + 0.455 * k, y + 0.238 * k]]).stream(pointStream).point;
        ...
        d3.geo.circle = function() {
          ...
          circle.precision = function(_2) {
            ...
            interpolate = d3_geo_circleInterpolate(angle * d3_radians, (precision = +_2) * d3_radians);
            return circle;
          };
        ...
        (d3.geo.transverseMercator = function() {
          ...
          projection.rotate = function(_2) {
            return _2 ? rotate([_2[0], _2[1], _2.length > 2 ? _2[2] + 90 : 90]) : (_2 = rotate(), [_2[0], _2[1], _2[2] - 90]);
          };
        ...
        d3.geom.hull = function(vertices) {
          ...
          hull.x = function(_2) {
            return arguments.length ? (x = _2, hull) : x;
          };
          hull.y = function(_2) {
            return arguments.length ? (y = _2, hull) : y;
          };
          return hull;
        };
        ...
        d3.geom.voronoi = function(points) {
          ...
          voronoi.x = function(_2) {
            return arguments.length ? (fx = d3_functor(x = _2), voronoi) : x;
          };
          voronoi.y = function(_2) {
            return arguments.length ? (fy = d3_functor(y = _2), voronoi) : y;
          };
        ...
        d3.geom.quadtree = function(points, x1, y1, x2, y2) {
          ...
          quadtree.x = function(_2) {
            return arguments.length ? (x = _2, quadtree) : x;
          };
          quadtree.y = function(_2) {
            return arguments.length ? (y = _2, quadtree) : y;
          };
          quadtree.extent = function(_2) {
            if (!arguments.length) return x1 == null ? null : [[x1, y1], [x2, y2]];
            if (_2 == null) x1 = y1 = x2 = y2 = null;
            else x1 = +_2[0][0], y1 = +_2[0][1], x2 = +_2[1][0], y2 = +_2[1][1];
            return quadtree;
          };
          quadtree.size = function(_2) {
            if (!arguments.length) return x1 == null ? null : [x2 - x1, y2 - y1];
            if (_2 == null) x1 = y1 = x2 = y2 = null;
            else x1 = y1 = 0, x2 = +_2[0], y2 = +_2[1];
            return quadtree;
          };
          return quadtree;
        };
        ...
        function d3_svg_line(projection) {
          ...
          line.interpolate = function(_2) {
            ...
            if (typeof _2 === "function") interpolateKey = interpolate = _2;
            else interpolateKey = (interpolate = d3_svg_lineInterpolators.get(_2) || d3_svg_lineLinear).key;
            return line;
          };
  ...
  var require_Histogram = __commonJS({
    "src/Histogram.js"(exports, module) {
      "use strict";
      var d3 = require_d3();
      ...
      OncoHistogram.prototype.render = function() {
        ...
        _self.container = _self.svg.append("g").attr("class", _self.prefix + "histogram").attr("width", function() {
          if (_self.rotated) {
            return _self.height;
          } else {
            return _self.width + _self.margin.left + _self.margin.right;
          }
        }).attr("height", _self.histogramHeight).style("margin-left", _self.margin.left + "px").attr("transform", function() {
          if (_self.rotated) {
        ...
        _self.histogram = _self.container.append("g").attr("transform", "translate(0,-" + (_self.totalHeight + _self.centerText) + ")");
        _self.renderAxis(topCount);
        _self.histogram.on("mouseover", function() {
          var target = d3.event.target;
          var domain = _self.domain[target.dataset.domainIndex];
          if (!domain) return;
          _self.emit(_self.type === "cnv" ? "cnvHistogramMouseOver" : "histogramMouseOver", { domain });
        ...
        _self.histogram.selectAll("rect").data(_self.domain).enter().append("rect").attr("class", function(d) {
          return _self.prefix + "sortable-bar " + _self.prefix + d.id + "-bar";
        }).attr("data-domain-index", function(d, i) {
          return i;
        }).attr("width", _self.barWidth - (_self.barWidth < 3 ? 0 : 1)).attr("height", function(d) {
      ...
      OncoHistogram.prototype.update = function(domain) {
        ...
        _self.histogram.selectAll("rect").data(_self.domain).attr("data-domain-index", function(d, i) {
          return i;
        }).transition().attr("width", _self.barWidth - (_self.barWidth < 3 ? 0 : 1)).attr("height", function(d) {
          return _self.histogramHeight * (_self.type === "cnv" ? d.cnv : d.count) / topCount;
        }).attr("y", function(d) {
          return _self.histogramHeight - _self.histogramHeight * (_self.type === "cnv" ? d.cnv : d.count) / topCount;
        }).attr("x", function(d) {
      ...
      OncoHistogram.prototype.resize = function(width, height) {
        ...
        _self.height = height;
        _self.histogramWidth = _self.rotated ? _self.height : _self.width;
        _self.container.attr("width", function() {
          if (_self.rotated) {
            return _self.height;
          } else {
            return _self.width + _self.margin.left + _self.margin.right;
        ...
        _self.histogram.attr("transform", "translate(0,-" + (_self.totalHeight + _self.centerText) + ")");
        _self.bottomAxis.attr("x2", _self.histogramWidth + 10);
      };
      OncoHistogram.prototype.renderAxis = function(topCount) {
        var _self = this;
        _self.bottomAxis = _self.histogram.append("line").attr("class", _self.prefix + "histogram-axis");
        _self.leftAxis = _self.histogram.append("line").attr("class", _self.prefix + "histogram-axis");
        _self.topText = _self.histogram.append("text").attr("class", _self.prefix + "label-text-font").attr("dy", ".32em").attr("text-anchor", "end");
        _self.middleText = _self.histogram.append("text").attr("class", _self.prefix + "label-text-font").attr("dy", ".32em").attr("text-anchor", "end");
        _self.leftLabel = _self.histogram.append("text").text(_self.type === "cnv" ? "CNV freq." : "Mutation freq.").attr({
      ...
      OncoHistogram.prototype.updateAxis = function(topCount) {
        var _self = this;
        _self.bottomAxis.attr("y1", _self.histogramHeight + _self.lineHeightOffset).attr("y2", _self.histogramHeight + _self.lineHeightOffset).attr("x2", _self.histogramWidth + _self.lineWidthOffset).attr("transform", "translate(-" + _self.lineHeightOffset + ",0)");
        _self.leftAxis.attr("y1", 0).attr("y2", _self.histogramHeight + _self.lineHeightOffset).attr("transform", "translate(-" + _self.lineHeightOffset + ",0)");
        _self.topText.attr("x", _self.centerText).text(topCount);
        var halfInt = parseInt(topCount / 2);
        var secondHeight = _self.histogramHeight - _self.histogramHeight / (topCount / halfInt);
        _self.middleText.attr("x", _self.centerText).attr("y", secondHeight).text(halfInt);
        _self.leftLabel.attr({
  ...
  // src/TrackGroup.js
  var require_TrackGroup = __commonJS({
    "src/TrackGroup.js"(exports, module) {
      "use strict";
      var d3 = require_d3();
      var _uniq = require_lodash2();
      var OncoTrackGroup;
      ...
      OncoTrackGroup.prototype.addTrack = function(tracks) {
        ...
        _self.collapsedTracks = _self.collapsedTracks.filter(function(collapsedTrack) {
          return !_self.tracks.some(function(track2) {
            return _.isEqual(collapsedTrack, track2);
          });
        });
      ...
      OncoTrackGroup.prototype.init = function(container) {
        ...
        _self.label = _self.container.append("text").attr("x", -6).attr("y", -11).attr("dy", ".32em").attr("text-anchor", "end").attr("class", _self.prefix + "track-group-label").text(_self.name);
        _self.legendObject = _self.container.append("svg:foreignObject").attr("width", 20).attr("height", 20);
        _self.legend = _self.legendObject.attr("x", 0).attr("y", -22).append("xhtml:div").html(_self.trackLegendLabel);
        _self.background = _self.container.append("rect").attr("class", "background").attr("width", _self.width).attr("height", _self.height);
        _self.refreshData();
      ...
      OncoTrackGroup.prototype.render = function() {
        ...
        _self.renderData();
        _self.legend.on("mouseover", function() {
      ...
      OncoTrackGroup.prototype.update = function(domain) {
        ...
        _self.computeCoordinates();
        _self.container.selectAll("." + _self.prefix + "track-data").data(_self.trackData).attr("x", function(d) {
          var domain2 = _self.domain[d.domainIndex];
          return _self.rotated ? domain2.y : domain2.x;
        }).attr("data-track-data-index", function(d, i2) {
          return i2;
      ...
      OncoTrackGroup.prototype.resize = function(width) {
        ...
        _self.cellWidth = _self.width / _self.domain.length;
        _self.background.attr("class", "background").attr("width", _self.width).attr("height", _self.height);
        _self.computeCoordinates();
        _self.totalHeight = _self.height + (_self.collapsedTracks.length ? _self.cellHeight : 0);
        _self.renderData();
      };
      OncoTrackGroup.prototype.computeCoordinates = function() {
        var _self = this;
        _self.y = d3.scale.ordinal().domain(d3.range(_self.length)).rangeBands([0, _self.height]);
        if (_self.column) {
          _self.column.remove();
        }
        if (_self.drawGridLines) {
          _self.column = _self.container.selectAll("." + _self.prefix + "column").data(_self.domain).enter().append("line").attr("class", _self.prefix + "column").attr("donor", function(d) {
            return d.id;
          }).attr("transform", function(d, i) {
            return "translate(" + (_self.rotated ? d.y : d.x) + ")rotate(-90)";
          }).style("pointer-events", "none").attr("x1", -_self.height);
        }
        if (typeof _self.row !== "undefined") {
          _self.row.remove();
        }
        _self.row = _self.container.selectAll("." + _self.prefix + "row").data(_self.tracks).enter().append("g").attr("class", _self.prefix + "row").attr("transform", function(d, i) {
          return "translate(0," + _self.y(i) + ")";
        });
        if (_self.drawGridLines) {
          _self.row.append("line").style("pointer-events", "none").attr("x2", _self.width);
        }
        var labels = _self.row.append("text");
        labels.attr("class", _self.prefix + "track-label " + _self.prefix + "label-text-font").on("click", function(d) {
          _self.domain.sort(d.sort(d.fieldName));
          _self.updateCallback(false);
        }).transition().attr("x", -6).attr("y", _self.cellHeight / 2).attr("dy", ".32em").attr("text-anchor", "end").text(function(d, i) {
        ...
        if (_self.expandable) {
          setTimeout(function() {
            ...
            _self.row.append("text").attr("class", removeTrackClass).text("-").attr("y", _self.cellHeight / 2).attr("dy", ".32em").on("click", function(d, i) {
              _self.removeTrack(i);
            }).attr("x", function(d) {
        ...
        if (_self.collapsedTracks.length && _self.expandable) {
          if (addButton.empty()) {
            addButton = _self.container.append("text").text("+").attr("class", "" + _self.prefix + "add-track").attr("x", -6).attr("dy", ".32em").attr("text-anchor", "end").on("click", function() {
      ...
      OncoTrackGroup.prototype.renderData = function() {
        var _self = this;
        var selection = _self.container.selectAll("." + _self.prefix + "track-data").data(_self.trackData);
        selection.enter().append("rect");
        var yIndexLookup = {};
        for (var i = 0; i < _self.tracks.length; i += 1) {
          yIndexLookup[_self.tracks[i].fieldName] = i;
        }
        _self.container.on("click", function(d) {
          var target = d3.event.target;
        ...
        selection.attr("data-track-data-index", function(d, i2) {
          return i2;
        }).attr("x", function(d) {
          var domain = _self.domain[d.domainIndex];
          return _self.rotated ? domain.y : domain.x;
        }).attr("y", function(d) {
          return _self.y(yIndexLookup[d.fieldName]);
        }).attr("width", _self.cellWidth).attr("height", _self.cellHeight).attr("fill", _self.fillFunc).attr("opacity", _self.opacityFunc).attr("class", function(d) {
          return _self.prefix + "track-data " + _self.prefix + "track-" + d.fieldName + " " + _self.prefix + "track-" + d.value + " " + _self.prefix + d.id + "-cell";
        });
  ...
  var require_Track = __commonJS({
    "src/Track.js"(exports, module) {
      "use strict";
      var OncoTrackGroup = require_TrackGroup();
      var OncoTrack;
      ...
      OncoTrack.prototype.init = function() {
        ...
        for (var k = 0; k < _self.groups.length; k++) {
          ...
          var trackContainer = _self.container.append("g").attr("transform", "translate(0," + _self.height + ")");
        ...
        _self.container.attr("width", _self.width).attr("height", _self.height).attr("class", _self.prefix + "track").attr("transform", function() {
      ...
      OncoTrack.prototype.resize = function(width, height, offset) {
        ...
        var translateDown = _self.rotated ? -(_self.offset + _self.height) : _self.padding + _self.offset;
        _self.container.attr("width", _self.width).attr("height", _self.height).attr("transform", function() {
          return (_self.rotated ? "rotate(90)" : "") + "translate(0," + translateDown + ")";
        });
        _self.height += labelHeight;
      };
  ...
  // src/MainGrid.js
  var require_MainGrid = __commonJS({
    "src/MainGrid.js"(exports, module) {
      "use strict";
      var d3 = require_d3();
      var OncoHistogram = require_Histogram();
      var OncoTrack = require_Track();
      var MainGrid;
      MainGrid = function(params, lookupTable, updateCallback, resizeCallback, x, y) {
        ...
        _self.donorTrack = new OncoTrack(
          params,
          _self.container,
          false,
          params.donorTracks,
          params.donorOpacityFunc,
          params.donorFillFunc,
          updateCallback,
          _self.height,
          _self.resizeCallback,
          _self.isFullscreen
        ...
        _self.geneTrack = new OncoTrack(
          params,
          _self.container,
          true,
          params.geneTracks,
          params.geneOpacityFunc,
          params.geneFillFunc,
          updateCallback,
          _self.width + _self.histogramHeight * _self.numTypes,
          _self.resizeCallback,
          _self.isFullscreen
        );
      ...
      MainGrid.prototype.loadParams = function(params) {
        ...
        if (_self.cnvObservations.length) {
          _self.types.push("cnv");
        }
        if (_self.ssmObservations.length) {
          _self.types.push("mutation");
        }
        _self.wrapper = d3.select(params.wrapper || "body");
      ...
      MainGrid.prototype.init = function() {
        var _self = this;
        _self.canvas = _self.wrapper.append("canvas").attr("class", _self.prefix + "canvas");
        _self.svg = _self.wrapper.append("svg").attr("class", _self.prefix + "maingrid-svg").attr("id", _self.prefix + "maingrid-svg").attr("width", "100%").style("position", "absolute").style("top", 0).style("left", 0);
        _self.container = _self.svg.append("g");
        _self.background = _self.container.append("rect").attr("class", "background").attr("width", _self.width).attr("height", _self.height);
      ...
      MainGrid.prototype.render = function() {
        ...
        _self.svg.on("mouseover", function(d) {
          ...
          if (!target.dataset.obsIndex || _self.crosshair) {
            return;
          }
        ...
        _self.container.selectAll("." + _self.prefix + "maingrid-svg").data(_self.observations).enter().append("path").attr("data-obs-index", function(d, i) {
      ...
      MainGrid.prototype.update = function(x, y) {
        ...
        _self.row.transition().attr("transform", function(d) {
          return "translate( 0, " + d.y + ")";
        });
        for (var i = 0; i < _self.numTypes; i++) {
          _self.container.selectAll("." + _self.prefix + "sortable-rect-" + _self.types[i]).transition().attr("d", function(d) {
            if (d.type === "cnv" || _self.heatMap) {
              return _self.getRectangularPath(d);
            }
            return _self.getCircularPath(d);
      ...
      MainGrid.prototype.computeCoordinates = function() {
        ...
        if (_self.drawGridLines) {
          _self.column = _self.gridContainer.selectAll("." + _self.prefix + "donor-column").data(_self.donors).enter().append("line").attr({
            x1: function(d) {
              return d.x;
            },
            x2: function(d) {
        ...
        _self.row = _self.gridContainer.selectAll("." + _self.prefix + "gene-row").data(_self.genes).enter().append("g").attr("class", _self.prefix + "gene-row").attr("transform", function(d) {
          return "translate(0," + d.y + ")";
        });
        if (_self.drawGridLines) {
          _self.row.append("line").attr("x2", _self.width).style("pointer-events", "none");
        }
        _self.row.append("text").attr("class", function(g) {
          return _self.prefix + g.id + "-label " + _self.prefix + "gene-label " + _self.prefix + "label-text-font";
        }).attr("x", -8).attr("y", _self.cellHeight / 2).attr("dy", ".32em").attr("text-anchor", "end").attr("style", function() {
          if (_self.cellHeight < _self.minCellHeight) {
            return "display: none;";
          } else {
            return "";
      ...
      MainGrid.prototype.resize = function(width, height, x, y) {
        ...
        _self.background.attr("width", _self.width).attr("height", _self.height);
        _self.computeCoordinates();
        if (_self.ssmObservations.length) {
      ...
      MainGrid.prototype.resizeSvg = function() {
        ...
        _self.canvas.attr("width", width).attr("height", height);
        if (_self.scaleToFit) {
        ...
        _self.container.attr("transform", "translate(" + (_self.margin.left + _self.leftTextWidth) + "," + (_self.margin.top + _self.histogramHeight * _self.numTypes) + ")");
      };
      MainGrid.prototype.defineCrosshairBehaviour = function() {
        ...
        _self.verticalCross = _self.container.append("line").attr("class", _self.prefix + "vertical-cross").attr("y1", -_self.histogramHeight).attr("y2", _self.height + _self.donorTrack.height).attr("opacity", 0).attr("style", "pointer-events: none");
        _self.horizontalCross = _self.container.append("line").attr("class", _self.prefix + "horizontal-cross").attr("x1", 0).attr("x2", _self.width + _self.histogramHeight + _self.geneTrack.height).attr("opacity", 0).attr("style", "pointer-events: none");
        _self.container.on("mousedown", function() {
      ...
      MainGrid.prototype.startSelection = function(e) {
        ...
        if (_self.crosshair && typeof _self.selectionRegion === "undefined") {
          ...
          _self.selectionRegion = _self.container.append("rect").attr("x", coord[0]).attr("y", coord[1]).attr("width", 1).attr("height", 1).attr("class", _self.prefix + "selection-region").attr("stroke", "black").attr("stroke-width", "2").attr("opacity", 0.2);
        }
      };
      ...
      MainGrid.prototype.defineRowDragBehaviour = function() {
        ...
        _self.row.on("mouseover", function() {
          ...
          d3.select(this).select("." + _self.prefix + "remove-gene").attr("style", "display: block");
        });
        _self.row.on("mouseout", function() {
          var curElement = this;
          curElement.timeout = setTimeout(function() {
            d3.select(curElement).select("." + _self.prefix + "remove-gene").attr("style", "display: none");
          }, 500);
        });
      };
      ...
      MainGrid.prototype.setHeatmap = function(active) {
        ...
        for (var i = 0; i < _self.numTypes; i++) {
          d3.selectAll("." + _self.prefix + "sortable-rect-" + _self.types[i]).transition().attr("d", function(d) {
            if (d.type === "cnv" || _self.heatMap) {
              return _self.getRectangularPath(d);
            }
            return _self.getCircularPath(d);
      ...
      MainGrid.prototype.nullableObsLookup = function(donor, gene) {
        ...
        if (_self.lookupTable.hasOwnProperty(donor.id) && _self.lookupTable[donor.id].hasOwnProperty(gene.id)) {
          return _self.lookupTable[donor.id][gene.id].join(", ");
        } else {
          return null;
        }
      };
  ...
  // src/OncoGrid.js
  var require_OncoGrid = __commonJS({
    "src/OncoGrid.js"(exports, module) {
      var d3 = require_d3();
      var cloneDeep = require_lodash();
      var MainGrid = require_MainGrid();
      var values = require_lodash3();
      ...
      var OncoGrid = function(params) {
        ...
        _self.container = d3.select(params.element || "body").append("div").attr("class", _self.prefix + "container").style("position", "relative");
        _self.initCharts();
      ...
      OncoGrid.prototype.calculatePositions = function() {
        var _self = this;
        var getX = d3.scale.ordinal().domain(d3.range(_self.donors.length)).rangeBands([0, _self.width]);
        ...
        var getY = d3.scale.ordinal().domain(d3.range(_self.genes.length)).rangeBands([0, _self.height]);
        for (var i = 0; i < _self.genes.length; i += 1) {
